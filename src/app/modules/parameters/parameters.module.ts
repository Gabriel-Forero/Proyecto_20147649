...
@NgModule({
  declarations: [CategoryCreationComponent, CategoryListComponent, CategoryEditionComponent, CategoryRemoveComponent, BrandCreationComponent, BrandEditionComponent, BrandListComponent],
  imports: [
    CommonModule,
